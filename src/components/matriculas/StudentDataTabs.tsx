...
const EmptyState = ({
  message = "Aún no hay información registrada",
}: {
  message?: string;
}) => (
...
export const StudentDataTabs = ({
  ...
  const getDocumentLabel = (docKey: string): string => {
    ...
    if (
      cleanKey.startsWith("hoja_matricula_") ||
      cleanKey.startsWith("hoja_de_matricula_") ||
      cleanKey.startsWith("hoja_de_matrícula_")
    ) {
        ...
        <TabsContent value="info" className="mt-0 h-full">
          {hasData(studentData, infoFields) || student.email ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              <DisplayField
                label="Primer Nombre"
                value={studentData.student_firstname1}
              />
              <DisplayField
                label="Segundo Nombre"
                value={studentData.student_firstname2}
              />
              <DisplayField
                label="Primer Apellido"
                value={studentData.student_lastname1}
              />
              <DisplayField
                label="Segundo Apellido"
                value={studentData.student_lastname2}
              />
              <DisplayField label="Email" value={student.email} />
              <DisplayField
                label="Tipo de Documento"
                value={studentData.student_id_type}
              />
              <DisplayField
                label="Número de Documento"
                value={studentData.student_id_number}
              />
              <DisplayField
              ...
              <DisplayField
                ...
                value={studentData.student_blood_abo}
              />
              <DisplayField label="RH" value={studentData.student_blood_rh} />
              <DisplayField
                label="Ciudad de Nacimiento"
                value={studentData.student_birth_city}
              />
              <DisplayField
                label="Religión"
                value={studentData.student_religion}
              />
            </div>
          ) : (
            <EmptyState />
        ...
        <TabsContent value="residencia" className="mt-0 h-full">
          {hasData(studentData, residenciaFields) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              ...
              <DisplayField
                label="Complemento"
                value={studentData.residence_address_complement}
              />
              <DisplayField
                label="Barrio"
                value={studentData.residence_barrio}
              />
              <DisplayField
                label="Estrato"
                value={studentData.residence_stratum}
              />
              <DisplayField label="Ciudad" value={studentData.residence_city} />
              <DisplayField
                label="Departamento"
                value={studentData.residence_department}
              />
              <DisplayField
                label="País"
                value={studentData.residence_country}
              />
            </div>
          ) : (
            <EmptyState />
        ...
        <TabsContent value="medica" className="mt-0 h-full">
          {hasData(studentData, medicaFields) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              <DisplayField
                label="EPS"
                value={studentData.student_health_eps}
              />
              <DisplayField
                label="Tiene Alergias"
                value={studentData.medical_has_allergies}
              />
              <DisplayField
                label="Detalle de Alergias"
                value={studentData.medical_allergies_detail}
              />
              <DisplayField
                label="Toma Medicamentos"
                value={studentData.medical_has_medications}
              />
              <DisplayField
                label="Detalle de Medicamentos"
                value={studentData.medical_medications_detail}
              />
              <DisplayField
                label="Tiene Historial Médico"
                value={studentData.medical_has_history}
              />
              <DisplayField
                label="Detalle de Historial"
                value={studentData.medical_history_detail}
              />
              <DisplayField
                label="Tiene Diagnóstico"
                value={studentData.medical_has_diagnosis}
              />
              <DisplayField
                label="Información Adicional"
                value={studentData.medical_diagnosis_additional_info}
              />
            </div>
          ) : (
            <EmptyState />
        ...
        <TabsContent value="padre" className="mt-0 h-full">
          {hasData(studentData, padreFields) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              <DisplayField
                label="Primer Nombre"
                value={studentData.father_firstname1}
              />
              <DisplayField
                label="Segundo Nombre"
                value={studentData.father_firstname2}
              />
              <DisplayField
                label="Primer Apellido"
                value={studentData.father_lastname1}
              />
              <DisplayField
                label="Segundo Apellido"
                value={studentData.father_lastname2}
              />
              <DisplayField
                label="Tipo de Documento"
                value={studentData.father_document_type}
              />
              <DisplayField
                label="Número de Documento"
                value={studentData.father_id_number}
              />
              <DisplayField
                label="Ciudad de Expedición"
                value={studentData.father_id_city}
              />
              ...
              <DisplayField
                ...
                value={studentData.father_workplace}
              />
              <DisplayField
                label="Dirección de Trabajo"
                value={studentData.father_work_address}
              />
              <DisplayField
                label="Teléfono de Trabajo"
                value={studentData.father_work_phone}
              />
              <DisplayField label="País" value={studentData.father_country} />
              <DisplayField
                label="Departamento"
                value={studentData.father_department}
              />
              <DisplayField label="Ciudad" value={studentData.father_city} />
              <DisplayField
                label="Vive con el Estudiante"
                value={studentData.father_lives_with_student}
              />
            </div>
          ) : (
            <EmptyState />
        ...
        <TabsContent value="madre" className="mt-0 h-full">
          {hasData(studentData, madreFields) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              <DisplayField
                label="Primer Nombre"
                value={studentData.mother_firstname1}
              />
              <DisplayField
                label="Segundo Nombre"
                value={studentData.mother_firstname2}
              />
              <DisplayField
                label="Primer Apellido"
                value={studentData.mother_lastname1}
              />
              <DisplayField
                label="Segundo Apellido"
                value={studentData.mother_lastname2}
              />
              <DisplayField
                label="Tipo de Documento"
                value={studentData.mother_document_type}
              />
              <DisplayField
                label="Número de Documento"
                value={studentData.mother_id_number}
              />
              <DisplayField
                label="Ciudad de Expedición"
                value={studentData.mother_id_city}
              />
              ...
              <DisplayField
                label="Lugar de Trabajo"
                value={studentData.mother_workplace}
              />
              <DisplayField
                label="Dirección de Trabajo"
                value={studentData.mother_work_address}
              />
              <DisplayField
                label="Teléfono de Trabajo"
                value={studentData.mother_work_phone}
              />
              <DisplayField label="País" value={studentData.mother_country} />
              <DisplayField
                label="Departamento"
                value={studentData.mother_department}
              />
              <DisplayField label="Ciudad" value={studentData.mother_city} />
              <DisplayField
                label="Vive con el Estudiante"
                value={studentData.mother_lives_with_student}
              />
            </div>
          ) : (
            <EmptyState />
          ...
          {hasData(studentData, acudienteFields) ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-base-100 rounded-lg">
              <DisplayField
                ...
                value={studentData.guardian_type}
              />
              <DisplayField
                label="Relación"
              ...
              <DisplayField
                label="Primer Nombre"
                value={studentData.guardian_firstname1}
              />
              <DisplayField
                label="Segundo Nombre"
                value={studentData.guardian_firstname2}
              />
              <DisplayField
                label="Primer Apellido"
                value={studentData.guardian_lastname1}
              />
              <DisplayField
                label="Segundo Apellido"
                value={studentData.guardian_lastname2}
              />
              <DisplayField
                label="Nombre Completo"
                value={studentData.guardian_full_name}
              />
              <DisplayField
                label="Tipo de Documento"
                value={studentData.guardian_document_type}
              />
              <DisplayField
                label="Número de Documento"
                value={studentData.guardian_id_number}
              />
              <DisplayField
                label="Ciudad de Expedición"
                value={studentData.guardian_id_city}
              />
              ...
              <DisplayField
                label="Lugar de Trabajo"
                value={studentData.guardian_workplace}
              />
              <DisplayField label="País" value={studentData.guardian_country} />
              <DisplayField
                label="Departamento"
                value={studentData.guardian_department}
              />
